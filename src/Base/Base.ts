...
namespace Base {
            ...
            for (let key in obj) {
                if (obj.hasOwnProperty(key)) {
                        ...
                        const [pre, post] =
                            Types.Object.toQueriesAccsessors[
                                options.arrayAccsessor ||
                                    Types.Object.defaultToQueriesOptions
                                        .arrayAccsessor
                            ]
                    ...
                    if (Guards.isTypeofObject(value)) {
                        ...
                        result.push(
                            `${accsessor}=${encodeURIComponent(`${value}`)}`
                        )
                    }
                } else {
                    continue
    ...
    export function String<S extends string>(string: S) {
        ...
        function joinQueryString<Q extends string>(
            queryString: Q
        ...
        function split<Separator extends string>(
            separator: string,
        ...
        function replaceAllSeparatedString<
